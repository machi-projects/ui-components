	...
	var Popup = function (_React$Component) {
		...
		_createClass(Popup, [{
			...
			value: function togglePopup(e) {
				...
				var element = _reactDom2.default.findDOMNode(this).getBoundingClientRect();
			...
			value: function render() {
				return _react2.default.createElement(Component, _extends({ ref: 'test' }, this.props, this.state, { openPopupOnly: this.openPopupOnly, closePopupOnly: this.closePopupOnly, togglePopup: this.togglePopup, isPopupOpen: this.state.isPopupOpen, removeClose: this.removeClose }));
			}
		}]);
