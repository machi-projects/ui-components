...
var _CalendarComponent = require("./CalendarComponent.js");
...
var _DropdownComponent = require("./DropdownComponent.js");
		...
		value: function render() {
			...
			return _react2.default.createElement(
				...
				_react2.default.createElement(
					...
					_react2.default.createElement(_CalendarComponent2.default, { date: date, year: year, month: month, onSelect: this.dateSelect }),
					isDateTimeField && _react2.default.createElement(
						...
						_react2.default.createElement(
							...
							_fzI18n.i18NProviderUtils.getI18NValue('crm.events.time')
						),
						_react2.default.createElement(
							"span",
							{ className: _DateTime2.default.dropDown },
							_react2.default.createElement(_DropdownComponent2.default, { id: "hours", suggestions: this.hourSuggestions, value: hours, valueField: "id", textField: "name", onSelect: this.hoursSelect })
						),
						_react2.default.createElement(
							"span",
							{ className: _DateTime2.default.dropDown },
							_react2.default.createElement(_DropdownComponent2.default, { id: "minutes", suggestions: this.minSuggestions, value: mins, valueField: "id", textField: "name", onSelect: this.minutesSelect })
						),
						_react2.default.createElement(
							"span",
							{ className: _DateTime2.default.dropDown },
							_react2.default.createElement(_DropdownComponent2.default, { id: "amPm", suggestions: this.ampmSuggestions, value: amPm, valueField: "id", textField: "name", onSelect: this.amPmSelect })
						)
					),
					_react2.default.createElement(
						"div",
						...
						_react2.default.createElement(
							...
							_fzI18n.i18NProviderUtils.getI18NValue("support.request.history.value.update.set")
						),
						_react2.default.createElement(
							"button",
							{ "data-testId": "clear", className: _DateTime2.default.canButton, onClick: this.handleClear },
							_fzI18n.i18NProviderUtils.getI18NValue("support.request.clear")
						)
					)
				)
			);
...
function mapStateToProps(state, props) {
	var timeZone = (0, _selectn2.default)("userDetails.timeZone", state);
	return { timeZone: timeZone };
}

exports.default = (0, _reactRedux.connect)(mapStateToProps)(DateTime);