  ...
  _createClass(MultiSelect, [{
    ...
    value: function render() {
      ...
      var selectedValues = stateSelectedValues.map(function (selectedValue, i) {
        return [_react2.default.createElement(SelectedItem, { value: selectedValue, allowClear: allowClear, textField: textField, onDelete: _this6.handleRemove, key: i })];
      });
      ...
      if (suggestions.length) {
        suggestionList = suggestions.map(function (suggestion, i) {
          ...
          return _react2.default.createElement(SuggestionItem, { index: i, key: i, textField: textField, valueField: valueField, onHover: _this6.handleHover, value: suggestion, onSelect: _this6.handleSelect, focus: focus });
        });
      } else {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement('input', { className: _MultiSelect2.default.inputFocus, placeholder: placeholder, ref: 'nameInput', readOnly: isReadOnly, onKeyDown: this.handleKeyDown, onKeyUp: this.handleKeyUp, onChange: this.handleChange, value: searchString })
          ),
  ...
  _createClass(SelectedItem, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(_Pill2.default, { backIcon: allowClear ? { name: "xCloseIcon", size: "small" } : null, text: value[textField], onBackIconClick: this.handleRemove })
      );
    }
  }]);
