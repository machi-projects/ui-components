...
var MultiLineInputBase = function (_React$Component) {
	...
	_createClass(MultiLineInputBase, [{
		...
		value: function render() {
			...
			var newProps = (0, _objectUtils.omit)(this.props, [removeTabIndex, "getValue", "getElementRef", "autoExpandX", "autoExpandY", "validation", "onPassValidation", "onFailValidation"]);
