...
var _typeChecker = require('../../utils/typeChecker');
	...
	_createClass(InputBase, [{
		...
		value: function validateInputBox(ev, targetTag, callback, validationProps) {
			...
			if (validationProps != null) {
				_validator2.default.executeValidation(targetTag.value, targetTag, validationProps);
			}
		}
	}, {
		key: 'render',
		value: function render() {
			...
			var newProps = (0, _objectUtils.omit)(this.props, ['validation', 'onPassValidation', 'onFailValidation']);
