...
var PictureBoxBase = function (_React$Component) {
	...
	_createClass(PictureBoxBase, [{
		...
		value: function render() {
			...
			var imgTagProps = (0, _objectUtils.extract)(this.props, ['src', 'alt']);
			var figureProps = (0, _objectUtils.omit)(this.props, ['src', 'alt', 'children', 'groupStyle', 'sourceStyle', 'captionStyle']);
