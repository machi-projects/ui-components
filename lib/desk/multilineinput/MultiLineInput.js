...
var MultiLineInput = function (_Component) {
	...
	_createClass(MultiLineInput, [{
		...
		value: function render() {
			...
			var newProps = (0, _objectUtils.omit)(this.props, ['className', 'styleId', 'focused', 'errored', 'valid', 'raised', "focusIn", "focusOut"]);
			...
			return _react2.default.createElement(_MultiLineInputBoxBase2.default, _extends({}, newProps, { onFocus: focusIn, onBlur: focusOut, className: classNames }));
		}
	}]);
