...
var InputBox = function (_React$Component) {
	...
	_createClass(InputBox, [{
		...
		value: function render() {
			...
			var newProps = (0, _objectUtils.omit)(this.props, ['textboxStyle', 'inputStyleId', 'typeName']);
			return _react2.default.createElement(
				'div',
				{ className: textboxStyle },
				_react2.default.createElement(_index.InputText, _extends({ type: 'text', styleId: inputStyleId }, newProps))
			);
		}
	}]);
...
var SearchIcon = function (_React$Component2) {
	...
	_createClass(SearchIcon, [{
		...
		value: function render() {
			...
			var classNames = (0, _classNames2.default)(iconstyle, isSearching ? _searchbox2.default["issearching"] : null);
...
var SearchBox = function (_React$Component3) {
	...
	_createClass(SearchBox, [{
		...
		value: function render() {
			...
			var searchBoxCollaspeStyle = _searchbox2.default["iscollaspe"];
			var searchBoxFloatStyle = _searchbox2.default["isfloatlabel"];
			var searchBoxInnerStyle = _searchbox2.default["innerboxstyle"];

			var searchiconStyle = _searchbox2.default['searchicon'];
			var textboxStyle = _searchbox2.default['textbox'];
			var floatboxStyle = _searchbox2.default['floatbox'];
...
SearchBox.propTypes = {
	...
	floatLabelOnSearchBox: _propTypes2.default.any,
