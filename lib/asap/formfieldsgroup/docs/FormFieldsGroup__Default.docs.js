...
var FormFieldsGroup__Default = function (_Component) {
	...
	function FormFieldsGroup__Default() {
		...
		return _possibleConstructorReturn(this, (FormFieldsGroup__Default.__proto__ || Object.getPrototypeOf(FormFieldsGroup__Default)).apply(this, arguments));
	}
		...
		value: function render() {
			return _react2.default.createElement(
				...
				_react2.default.createElement(
					_index.FormFieldsGroup,
					{ validate: false },
					_react2.default.createElement(
						_index2.FormFieldSet,
						{
							fieldId: 'Fruits',
							value: ['B', 'C'],
							validation: {
...
exports.default = FormFieldsGroup__Default;


if (__DOCS__) {
	FormFieldsGroup__Default.docs = {
		componentGroup: _index.FormFieldsGroup.docs.componentGroup
	};
}