			...
			return _react2.default.createElement(
				...
				_react2.default.createElement(
					...
					{ ref: this.setDropPopupRef, onClick: removeClose,
						className: _DropDown2.default[styleId + '_droppopup'] + ' ' + (isPopupReady ? _DropDown2.default.ready : '') + ' ' + (isPopupOpen ? _DropDown2.default.opened : '') + ' ' + (position == 'topCenter' ? _DropDown2.default[styleId + '_listViewTop'] : _DropDown2.default[styleId + '_listview']) },
					...
					suggestions.length ? _react2.default.createElement(
						...
						'div',
						{ className: _DropDown2.default[styleId + '_notfound'] },
						noMatchesLabel
					)
				)
			);
