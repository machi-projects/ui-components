	...
	_createClass(DropDown, [{
		...
		value: function render() {
			...
			return _react2.default.createElement(
				...
				_react2.default.createElement(
					'div',
					{ ref: this.setDropPopupRef, className: isPopupOpen ? position == 'top' ? _DropDown2.default.listViewTop : _DropDown2.default.listview : _DropDown2.default.hide },
						...
						suggestions.map(function (opt, index) {
							...
							return _react2.default.createElement(
								'li',
								{
									...
									className: _this4.state.count == index ? _DropDown2.default.bccolor : _DropDown2.default.normal,
