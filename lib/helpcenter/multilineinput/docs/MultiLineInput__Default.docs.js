...
var MultiLineInput__Default = function (_Component) {
	...
	function MultiLineInput__Default() {
		...
		return _possibleConstructorReturn(this, (MultiLineInput__Default.__proto__ || Object.getPrototypeOf(MultiLineInput__Default)).apply(this, arguments));
	}
	...
	_createClass(MultiLineInput__Default, [{
		...
		value: function render() {
			return _react2.default.createElement(
				...
				null,
				'test multilineinput;',
				_react2.default.createElement(_index.MultiLineInput, {
					required: true,
					validation: {
						validate: false,
						validateOn: 'onChange',
				...
				_react2.default.createElement(_index.MultiLineInput, { styleId: 'myinput' })
			);
		}
	}]);
...
exports.default = MultiLineInput__Default;


if (__DOCS__) {
	MultiLineInput__Default.docs = {
		componentGroup: _index.MultiLineInput.docs.componentGroup
	};
}