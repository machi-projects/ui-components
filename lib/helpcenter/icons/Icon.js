...
var Icon = function (_Component) {
	...
	_createClass(Icon, [{
		...
		value: function componentDidMount() {
			if (document.getElementById('zohohc-common-icons-holder') == null) {
				var child = document.createElement('div');
				child.id = 'zohohc-common-icons-holder';
				document.body.appendChild(child);
			}

			if (document.getElementById('zohohc-common-icons') == null) {
				_reactDom2.default.render(_react2.default.createElement(_IconContent2.default, null), document.getElementById('zohohc-common-icons-holder'));
			}
		}
	}, {
		key: 'render',
