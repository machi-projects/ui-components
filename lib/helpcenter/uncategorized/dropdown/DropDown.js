...
var DropDown = function (_React$Component) {
	...
	function DropDown(props) {
		...
		var _getSelectedValue = getSelectedValue((0, _common.formatValue)(props.defaultOptions), props.defaultValue),
	...
	_createClass(DropDown, [{
		...
		value: function componentWillReceiveProps(nextprops) {
			...
			if (nextprops.value && nextprops.value !== this.props.value || nextprops.options && !(0, _objectUtils.equals)(nextprops.options, this.props.options)) {

				this.setState(getSelectedValue((0, _common.formatValue)(nextprops.options), nextprops.value));
			}
		...
		value: function render() {
			...
			return _react2.default.createElement(
				'div',
				{ className: _DropDown2.default.main, ref: this.setRef, tabIndex: tabIndex, onFocus: focusIn, onBlur: focusOut, onClick: onClick },
				...
				_react2.default.createElement(
					...
					{ ref: this.setDropPopupRef,
						className: _DropDown2.default.droppopup + ' ' + (isPopupReady ? _DropDown2.default.ready : '') + ' ' + (isPopupOpen ? _DropDown2.default.opened : '') + ' ' + (position == 'top' ? _DropDown2.default.listViewTop : _DropDown2.default.listview) },
					enableSearch && _react2.default.createElement(
						...
						_react2.default.createElement('input', {
							type: 'text',
							ref: 'input',
							className: _DropDown2.default.searchicon,
						...
						suggestions.map(function (opt, index) {
							...
							return _react2.default.createElement(
								'li',
								{
									...
									className: _this6.state.count == index ? _DropDown2.default.bccolor : _DropDown2.default.normal,
