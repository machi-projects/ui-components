	...
	_createClass(MultiSelect, [{
		...
		value: function render() {
			...
			if (suggestions.length) {
				...
				suggestionList = _react2.default.createElement(
					'div',
					{ className: _MultiSelect2.default[styleId + '_notfound'] },
					noMatchesLabel
				);
			}
			...
			return _react2.default.createElement(
				...
				_react2.default.createElement(
					...
					{ ref: this.setDropPopupRef, onClick: removeClose,
						...
						className: _MultiSelect2.default[styleId + '_droppopup'] + ' ' + (isPopupReady ? _MultiSelect2.default.ready : '') + ' ' + (isPopupOpen ? _MultiSelect2.default.opened : '') + ' ' + (position == 'topCenter' ? _MultiSelect2.default[styleId + '_ListAdsTop'] : _MultiSelect2.default[styleId + '_ListAds']) },
					suggestionList
				),
				_react2.default.createElement('div', { className: _MultiSelect2.default[styleId + '_clr'] })
			);
...
MultiSelect.propTypes = (_MultiSelect$propType = {
	...
	noMatchesLabel: _propTypes2.default.string,
