...
var DropdownComponent = function (_React$Component) {
  ...
  function DropdownComponent(props) {
    ...
    _common.bind.apply(_this, ["handleFocus", "handleSelect", "handleKeyUp", "handleToggle", "handleChange", "onChangeValue", "setInputRef"]);
    ...
    suggestions = suggestions ? (0, _common.formatValue)(suggestions, props.valueField, props.textField) : [];
    value = value ? value : [suggestions[0]];
    var selectedValue = value ? (0, _common.formatValue)([value], props.valueField, props.textField)[0] : null;
  ...
  _createClass(DropdownComponent, [{
    ...
    value: function handleKeyUp(e) {
      ...
      suggestions = (0, _common.formatValue)(suggestions, valueField, textField); //
      value = value && value || suggestions[0];
      value = (0, _common.formatValue)([value], valueField, textField); //
    ...
    value: function componentWillReceiveProps(nextProps) {
      ...
      if ((0, _objectUtils.deepEqualObject)(nextProps, this.props) == false) {
        ...
        suggestions = suggestions ? (0, _common.formatValue)(suggestions, valueField, textField) : [];
        value = value ? value : suggestions[0];
        var selectedValue = value ? (0, _common.formatValue)([value], valueField, textField)[0] : null;
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          'div',
          { className: styles.container ? styles.container : this.props.dropStyle ? _DropdownComponent2.default.dropStyle : _DropdownComponent2.default.dropdown },
          _react2.default.createElement(
            'span',
            { className: _DropdownComponent2.default.flexline },
            selectedValue && _react2.default.createElement(
              'span',
              { className: this.props.dropStyle ? _DropdownComponent2.default.dropSelectName : _DropdownComponent2.default.selectname },
        ...
        _react2.default.createElement(
          ...
          searchField && _react2.default.createElement(
            ...
            _react2.default.createElement('input', { type: 'text', className: _DropdownComponent2.default.searchicon, onChange: this.handleChange,
          ...
          _react2.default.createElement(
            'ul',
            { className: _DropdownComponent2.default.listmenu },
