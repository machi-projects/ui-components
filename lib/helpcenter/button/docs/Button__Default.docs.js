...
var Button__Default = function (_Component) {
	...
	function Button__Default() {
		...
		return _possibleConstructorReturn(this, (Button__Default.__proto__ || Object.getPrototypeOf(Button__Default)).apply(this, arguments));
	}
...
exports.default = Button__Default;


if (__DOCS__) {
	Button__Default.docs = {
		componentGroup: _index.Button.docs.componentGroup
	};
}