      ...
      return React.createElement(
        ...
        React.createElement(
          ...
          React.createElement(
            ...
            React.createElement('input', { type: 'text', ref: 'input', className: style.searchicon, onKeyDown: this.keyPress.bind(this), onChange: this.handleChange, value: this.state.searchStr }),
            React.createElement(
              'div',
              { className: style.searchIconPosSet },
              React.createElement(Icon, { icon: 'searchIcon', iconColor: 'greyShade2', size: 'size15' })
            )
          ),
          suggestions.length ? React.createElement(
            ...
            suggestions.map(function (opt, index) {
              ...
              return React.createElement(
                'li',
                { key: index + "opt", ref: "suggestion_" + index, className: _this4.state.count == index ? style.bccolor : style.normal, onClick: _this4.textidchange.bind(_this4, val, name, index) },
                name,
                ' '
              );
            })
