  ...
  _createClass(MultiSelect, [{
    ...
    value: function render() {
      ...
      var selectedValues = stateSelectedValues.map(function (selectedValue, i) {
        return [React.createElement(SelectedItem, { value: selectedValue, allowClear: allowClear, textField: textField, onDelete: _this6.handleRemove, key: i })];
      });
      ...
      if (suggestions.length) {
        suggestionList = suggestions.map(function (suggestion, i) {
          ...
          return React.createElement(SuggestionItem, { index: i, key: i, textField: textField, valueField: valueField, onHover: _this6.handleHover, value: suggestion, onSelect: _this6.handleSelect, focus: focus });
        });
      } else {
      ...
      return React.createElement(
        ...
        React.createElement(
          ...
          React.createElement(
            ...
            React.createElement('input', { className: style.inputFocus, placeholder: placeholder, ref: 'nameInput', readOnly: isReadOnly, onKeyDown: this.handleKeyDown, onKeyUp: this.handleKeyUp, onChange: this.handleChange, value: searchString })
          ),
  ...
  _createClass(SelectedItem, [{
    ...
    value: function render() {
      ...
      return React.createElement(
        ...
        React.createElement(Pill, { backIcon: allowClear ? { name: "xCloseIcon", size: "small" } : null, text: value[textField], onBackIconClick: this.handleRemove })
      );
    }
  }]);
